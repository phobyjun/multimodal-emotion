...
if __name__ == '__main__':
    ...
    target_audios = 'C:/Users/choihyeonjun/Desktop/Hyeonjun/WorkSpace/SFTP/datasets/ASD/AVA/ava_test/audio'
    ...
    for video_name in all_videos:
        ...
        actual_file_name = glob.glob(
            os.path.join(ava_video_dir, video_name+'*'))
