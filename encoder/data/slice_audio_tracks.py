...
def extract_audio_tracks_time(audio_dir, output_dir, balanced_gb, entity_list):
    ...
    for l in balanced_gb['entity_id'].unique().tolist():
        ...
        if not os.path.isdir(d):
            ...
            savedir = d
            savedir = savedir.replace(os.path.basename(
                d), os.path.basename(d).split(':')[0]+'_'+os.path.basename(d).split(':')[1])
    ...
    for entity_idx, entity in enumerate(entity_list):
        ...
        # print("instance_data: ", instance_data.head())
        ...
        instance_path = os.path.join(
            output_dir, entity_id.split(':')[0]+'_'+entity_id.split(':')[1]+'.wav')
...
if __name__ == '__main__':
    ava_audio_dir = 'C:/Users/choihyeonjun/Desktop/Hyeonjun/WorkSpace/SFTP/datasets/ASD/AVA/ava_test/audio'
    output_dir = 'C:/Users/choihyeonjun/Desktop/Hyeonjun/WorkSpace/SFTP/datasets/ASD/AVA/ava_test/audio_s/'
    csv = 'C:/Users/choihyeonjun/Desktop/Hyeonjun/WorkSpace/SFTP/datasets/ASD/AVA/ava_test/csv/ava_activespeaker_train_augmented.csv'
    ...
    extract_audio_tracks_time(
        ava_audio_dir, output_dir, sorted_df, entity_list)
