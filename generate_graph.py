...
def main():
    ...
    tpath_key = os.path.join('/local_datasets/KEMDy20-2/graphs', '{}_{}_{}_{}_{}'.format(args.feature, graph_data['numv'], graph_data['time_edge'], graph_data['cross_identity'], graph_data['edge_weight']))

    for mode in ['train', 'val']:
        # specifies location of the features within feature path
        dpath_mode = os.path.join('/local_datasets/KEMDy20-2/features', mode, '*.pkl')
        print(dpath_mode)
